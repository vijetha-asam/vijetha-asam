...
## 💼 About Me
SDET with around 3 years of experience in Selenium, Java, API testing and AI-based automation projects.
...
## 🚀 Key Highlights
- Built RESTful API automation framework using REST Assured with TestNG
- Automated GET, POST, PUT, DELETE API requests using TestNG test structure
- Validated status codes, response body, headers, and response time
- Implemented data-driven API testing using TestNG DataProvider
- Used POJO classes and JSON parsing for payload handling
